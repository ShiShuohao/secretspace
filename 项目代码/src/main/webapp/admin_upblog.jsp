...
<div style="position: absolute;height: 600px;width: 70%;left: 15%;margin-top: 88px;background: white;box-shadow: 0 0 3px 3px #f3f3f3;text-align: center;">
    <span style="position: absolute;font-size: 20px;top: 5%;left: 50%;transform: translate(-50%,-50%);color: #0095ff;">发&nbsp;&nbsp;&nbsp;&nbsp;布&nbsp;&nbsp;&nbsp;&nbsp;博&nbsp;&nbsp;&nbsp;&nbsp;客</span>
    <form action="upblog" method="post" id="form" style="position: absolute;height: 540px;width: 100%;transform: translate(-50%,-50%);top: 54%;left: 50%;">
        <span style="position: absolute;top: 5%;left: 30%;font-size: 17px;">标题</span>
        <input type="text" name="headline" id="headline" placeholder="请输入标题" style="position: absolute;top: 5%;left: 35%;width: 35%;height: 25px;"><br>
        ...
        <input type="date" name="uptime" id="uptime" value="2000-01-01" style="position: absolute;top: 12%;left: 55%;width: 15%;height: 25px;">
        <%--富文本编辑器的区域--%>
