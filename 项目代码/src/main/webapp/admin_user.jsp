...
<div style="width: 100%;height: 90px;position: fixed;top: 0;left: 0;background: white;box-shadow: 0 0 3px 3px #f3f3f3;z-index: 1;">
    ...
    <a href="admin_user.jsp" id="a7" style="position: absolute;font-size: 16px;top: 75%;left: 40%;transform: translate(-50%,-50%);text-decoration: none;color: black;transition: 0.5s;font-weight: bold;">用户管理</a>
...
<div style="position: absolute;height: auto;width: 50%;left: 25%;background: white;box-shadow: 0 0 3px 3px #f3f3f3;text-align: center;margin-top: 88px;">
    ...
    <c:forEach var="user" items="${userList}">
        <tr>
            ...
            <td style="width: 30%;text-align: center;"><a href="admin_user?username=${user.username}" style="text-decoration: none;font-size: 13px;background: #0095ff;color: white;padding-right: 5px;padding-left: 5px;padding-top: 3px;padding-bottom: 3px;border-radius: 5px;transition: 0.5s;" id="delete">删除</a></td>
        </tr>
    </c:forEach>
    </table>
</div>
